...
function Viz() {
    ...
    return (
        <div>
            ...
            <nav class="viz-nav">
                <label for="touch11">
                    <div class="viz-title">Identify Function</div>
                </label>
                <input type="checkbox" id="touch11" />
                <div class="slide11">
                    <div class="question">
                        <a href="#" onClick={handleClick}>Question for NOVA: <br></br><p>What is the purpose of the Identify function in the NIST CSF?</p></a>
                    </div>
