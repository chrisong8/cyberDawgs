        ...
        <div className="section-container">
            ...
            <div className="features-container">
                <div className="features-section">
                    ...
                    <img className="feature-image" src="/pics/chris.jpg" alt="Feature 1" />
                    ...
                    <div className="feature">
                    <img className="feature-image" src="/pics/chris.jpg" alt="Feature 2" />
                    ...
                    <div className="feature">
                    <img className="feature-image" src="/pics/chris.jpg" alt="Feature 3" />
                    <h2 className="feature-title">Nova Response Feature</h2>
            ...
            <div className="team-intro-section">
                ...
                <Card className="my-card">
                    <Card.Img variant="top" src="../../public/pics/chris.jpg" className="card-img" />
                    <Card.Body>
                ...
                <Card className="my-card">
                    <Card.Img variant="top" src="../../public/pics/Dan.png" className="card-img" />
                    <Card.Body>
                ...
                <Card className="my-card">
                    <Card.Img variant="top" src="../../public/pics/matt.JPG" className="card-img" />
                    <Card.Body>
                ...
                <Card className="my-card">
                    <Card.Img variant="top" src="../../public/pics/conn.JPG" className="card-img" />
                    <Card.Body>
                ...
                <Card className="my-card">
                    <Card.Img variant="top" src="../../public/pics/mil.jpg" className="card-img" />
                    <Card.Body>
